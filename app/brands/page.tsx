            ...
            >
              {IMAGES.ownBrands.map((brand, index) => (
                <TabsTrigger
                  ...
                  className="text-lg py-4 data-[state=active]:bg-[#8B5A2B] data-[state=active]:text-white"
                >
                  {brand.name}
                </TabsTrigger>
              ))}
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
                  ...
                  <div className="lg:col-span-2 space-y-6">
                    <div
                      className="p-8 bg-[#f8f5f0] rounded-xl animate-rotate-in"
                    ...
                    >
                      <div className="mb-8 relative h-16">
                        <Image
                          ...
                          alt={`${brand.name} logo`}
                          fill
                          className="object-contain object-left w-32 h-32 mb-2"
                        />
                      </div>
                      <h3 className="text-2xl font-bold mb-4">{brand.name}</h3>
                      <p className="text-muted-foreground">{brand.description}</p>
                      <Button className="mt-6 bg-[#8B5A2B] hover:bg-[#704626] group">
                        Learn More
                ...
                {/* Banner Image */}
                <div
                  className="mt-16 relative h-80 rounded-xl overflow-hidden animate-fade-in"
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
                    <div className="text-center text-white">
                      <h3 className="text-3xl font-bold mb-4">Explore {brand.name} Collection</h3>
                      <Button className="bg-white text-[#8B5A2B] hover:bg-white/90">
                        View Catalog
